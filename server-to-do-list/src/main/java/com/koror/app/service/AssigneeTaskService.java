...
public class AssigneeTaskService extends AbstractService implements IAssigneeTaskService {
    ...
    public void deleteAssigneeByParam(String userId, String taskId) {
        ...
        for(AssigneeTask assigneeTaskTemp : repository.getList()){
            if(userId.equals(assigneeTaskTemp.getUser()) && taskId.equals(assigneeTaskTemp.getTask()))
